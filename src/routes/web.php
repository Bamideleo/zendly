...
Route::middleware(['auth','maintanance','demo.mode'])->prefix('user')->name('user.')->group(function () {
    Route::middleware(['checkUserStatus'])->group(function(){
        ...
        Route::get('sms/test', [PhoneBookController::class, 'testing']);
        ...
        Route::get('email/get-lead/', [EmailContactController::class, 'getLead'])->name('email.lead');
        // Route::get('email/get_bussiness_data/{id}', [EmailContactController::class, 'get_bussiness_data'])->name('email.bussiness');
        Route::post('email/get_bussiness_data', [EmailContactController::class, 'get_bussiness_data'])->name('email.bussiness');
        Route::post('email/get_search_data', [EmailContactController::class, 'leads_search'])->name('email.search');
        ...
        Route::get('email/email-provider', [ManageEmailController::class, 'emailprovider'])->name('manage.email.provider');
        Route::get('email/edit/{id}', [ManageEmailController::class, 'edit'])->name('manage.email.edit');
        ...
        Route::post('email/mail-method', [ManageEmailController::class, 'sendMailMethod'])->name('manage.email.mailmethod');
        Route::post('email/activate-method', [ManageEmailController::class, 'activateapi'])->name('manage.email.activate-method');
        Route::post('email/mail-update/{id}', [ManageEmailController::class, 'mailUpdate'])->name('manage.email.mailupdate');
        Route::post('email/mail-tester/{id}', [ManageEmailController::class, 'mailTester'])->name('manage.email.mailtester');
        

        //Sms log
        Route::get('sms/apigate', [ManageSMSController::class, 'apigateway'])->name('sms.apigate');
        Route::get('sms/edit/{id}', [ManageSMSController::class, 'edit'])->name('sms.edit');
        Route::post('sms/activate-api', [ManageSMSController::class, 'activateapi'])->name('sms.activateapi');
        Route::post('sms/usersmsgate', [ManageSMSController::class, 'usersmsGateway'])->name('sms.usergate');
        Route::post('sms/update/{id}', [ManageSMSController::class, 'update'])->name('sms.update');
        ...
        Route::post('sms/store', [ManageSMSController::class, 'store'])->name('sms.store');
         ...
         //whatsapp log
         Route::get('whatsapp/get-api', [ManageWhatsappController::class, 'whatsappapi'])->name('whatsapp.api');
         Route::get('whatsapp/edit-whatsapp-api/{id}', [ManageWhatsappController::class, 'editwhatsapp'])->name('whatsapp.editapi');
         ...
         Route::post('whatsapp/save-whatsapapi', [ManageWhatsappController::class, 'savewhatapp'])->name('whatsapp.save');
         Route::post('whatsapp/update-whatsapapi', [ManageWhatsappController::class, 'updatewhatsapp'])->name('whatsapp.update');
         Route::post('whatsapp/statusupdate', [ManageWhatsappController::class, 'statusUpdate'])->name('whatsapp.statusupdate');
         Route::post('whatsapp/delete', [ManageWhatsappController::class, 'delete'])->name('whatsapp.delete');
        ...
        Route::get('agency', [HomeController::class,'agency'])->name('agency.index');
        Route::post('save-agency', [HomeController::class,'save_sub_user'])->name('agency.save');
        Route::post('upgrade-agency', [HomeController::class,'upgrade_sub_user'])->name('agency.upgrade');
        Route::get('search-agency', [HomeController::class,'search'])->name('agency.search');
        Route::post('delete-agency', [HomeController::class,'delete_sub_user'])->name('agency.delete');
