...
class WhatsappDeviceController extends Controller
{
    ...
    public function create()
    {
        ...
        $whatsapps = WhatsappDevice::where('is_admin',$user)->orderBy('id','desc');
        ...
        $whatsapps = WhatsappDevice::where('is_admin',$user)->orderBy('id', 'desc')->paginate(paginateNumber());
    ...
    public function store(Request $request)
    {
        ...
        $whatsapp->is_admin = auth()->guard('admin')->user()->id;
