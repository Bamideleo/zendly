			...
			<div class="col-xl-12">
				<div class="table_heading d-flex align--center justify--between">
                    <nav  aria-label="breadcrumb">
					  	<ol class="breadcrumb">
					    	<li class="breadcrumb-item"><a href="{{route('user.manage.email.provider')}}"> {{ translate('Mail Configuration')}}</a></li>
					    	<li class="breadcrumb-item" aria-current="page">{{__($mail->name)}}</li>
					  	</ol>
					</nav>
                </div>
				...
				<div class="card">
					<div class="card-header bg--lite--violet text-center">
						<h6 class="text-light">{{__($mail->name)}}  {{ translate('Mail Configuration Update Form')}}</h6>
					</div>
					<div class="card-body">
						<form action="{{route('user.manage.email.mailupdate', $mail->id)}}" method="POST">
							@csrf
	...
	<div class="container-fluid p-0 mb-3 pb-2">
		<div class="row d-flex align--center rounded">
			<div class="col-xl-12">
				<div class="card">
					<div class="card-header bg--lite--violet text-center">
						<h6 class="text-light">{{__($mail->name)}}  {{ translate('Mail Configuration Test Form')}}</h6>
					</div>
					<div class="card-body">
						<form action="{{route('user.manage.email.mailtester', $mail->id)}}" method="POST">
							@csrf
							<div class="row"> 
