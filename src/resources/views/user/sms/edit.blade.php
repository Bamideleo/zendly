			...
			<div class="col-xl-12">
				<div class="table_heading d-flex align--center justify--between">
                    <nav  aria-label="breadcrumb">
					  	<ol class="breadcrumb">
					    	<li class="breadcrumb-item"><a href="{{route('user.sms.apigate')}}">{{ translate('Api Gateway')}}</a></li>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="{{route('user.sms.update', $smsGateway->id)}}" method="POST" enctype="multipart/form-data">
							@csrf
