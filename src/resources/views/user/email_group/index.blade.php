			 ...
			 <div class="row align--center px-2">
	                	...
	                	<div class="col-12 col-md-8 col-lg-8 col-xl-7">
	                		<div class="row justify-content-end">
			                    ...
			                    <div class="col-12 col-md-4 col-lg-4 col-xl-3 py-1">
			                    	<a href="{{route('user.email.contact.index')}}" class="w-100 d-block btn--primary text--light border-0 w-100 px-1 py-2 rounded ms-2">{{ translate('Contact')}}</a>
			                    </div>
		                    ...
		                    @forelse($groups as $group)
			                    <tr class="@if($loop->even) table-light @endif">
				                    ...
				                    <td data-label="{{ translate('Email')}}">
				                    	<a href="{{route('user.email.contact.group', $group->id)}}" class="s_btn--primary text--light">{{ translate('view emails')}}</a>
				                    </td>
