<div id="sideContent" class="side_content">
    ...
    <div class="side_bar_menu_container">
        <div class="side_bar_menu_list">
            ...
            <ul>
                <li>
                    <a class="ms--1 d--flex align--center {{sidebarMenuActive(['user.phone.book.group.index', 'user.phone.book.contact.index','user.phone.book.template.index', 'user.phone.book.sms.contact.group'])}} side_bar_twenty_list" href="javascript:void(0)"><div><span class="me-4"><i class="fs-5 las la-sms text--light"></i></span>{{ translate('(Done For You)')}}</div><i class="las la-angle-down icon20"></i></a>
                    <ul class="first_twenty_child {{menuActive('user.phone.book*',20)}}">
                        <li>
                            <a class="{{menuActive(['user.phone.book.group.index','user.phone.book.sms.contact.group'])}}" href="{{route('user.phone.book.group.index')}}"><i class="lab la-jira me-3"></i>{{ translate('List')}}</a>
                            <a class="{{menuActive('user.phone.book.contact.index')}}" href="{{route('user.phone.book.contact.index')}}"><i class="lab la-jira me-3"></i>{{ translate('Offers')}}</a>
                            <a class="{{menuActive('user.phone.book.contact.index')}}" href="{{route('user.phone.book.contact.index')}}"><i class="lab la-jira me-3"></i>{{ translate('Email Template')}}</a>
                        </li>
                    </ul>
                </li>
                ...
                <!-- <li>
                    ...
                    <ul class="first_eight_child {{menuActive('user.email*',8)}}">
                        <li>
                            <a class="{{menuActive(['user.email.group.index','user.email.contact.group'])}}" href="{{route('user.email.group.index')}}"><i class="lab la-jira me-3"></i>{{ translate('List')}}</a>
            ...
            <ul>
                <li>
                    ...
                    <ul class="first_nine_child {{menuActive('user.sms*',9)}}">
                        <li>
                        <a class="{{menuActive('user.manage.email.provider')}}" href="{{route('user.phone.book.group.index')}}"><i class="lab la-jira me-3"></i>{{ translate('List')}}</a>
                            ...
                            <a class="{{menuActive('user.sms.index')}}" href="{{route('user.sms.index')}}"><i class="lab la-jira me-3"></i>{{ translate('All SMS')}}</a>
                             ...
                             <a class="{{menuActive('user.sms.apigate')}}" href="{{route('user.sms.apigate')}}"><i class="lab la-jira me-3"></i>{{ translate('SMS Api Gateway')}}</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="first_twenty_three_child {{menuActive('user.whatsapp*',23)}}">
                        <li>
                            <a class="{{menuActive('user.whatsapp.api')}}" href="{{route('user.whatsapp.api')}}"><i class="lab la-jira me-3"></i>{{ translate('Add Device')}}</a>
                ...
                <li>
                    ...
                    <ul class="first_ten_child {{menuActive('user.manage.email*',10)}}">
                        <li>
                        <a class="{{menuActive('user.manage.email.provider')}}" href="{{route('user.email.group.index')}}"><i class="lab la-jira me-3"></i>{{ translate('List')}}</a>
                            ...
                            <a class="{{menuActive(['user.manage.email.index','user.manage.email.search', 'user.manage.email.date.search'])}}" href="{{route('user.manage.email.index')}}"><i class="lab la-jira me-3"></i>{{ translate('All Email')}}</a>
                             ...
                             <a class="{{menuActive('user.manage.email.provider')}}" href="{{route('user.manage.email.provider')}}"><i class="lab la-jira me-3"></i>{{ translate('Mail Configuration')}}</a>
                        </li>
                    </ul>
                </li>
            ...
            <ul>
                <li class="side_bar_list d--flex align--center">
                    <a class="ms--1 d--flex align--center {{menuActive(['user.multiple', 'user.multiple'])}}" href="{{route('user.transaction.history')}}">
                        <div>
                            <span class="me-3"><i class="fs-5 las la-credit-card text--light me-2"></i></span>{{ translate('Multiple Income')}}
                        </div>
                    </a>
                </li>
            ...
            <ul>
                <li class="side_bar_list d--flex align--center">
                    <a class="ms--1 d--flex align--center {{menuActive('user.agency.index')}}" href="{{route('user.agency.index')}}">
                        <div>
                            <span class="me-3"><i class="fs-5 las la-paper-plane text--light me-2"></i></span> {{ translate('Agency')}}
                        </div>
                    </a>
                </li>
            </ul>
