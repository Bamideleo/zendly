...
<section class="mt-3 rounded_box">
	<div class="container-fluid p-0 mb-3 pb-2">
		<div class="row">
			<div class="col-xl-4">
                <form action="{{route('user.whatsapp.save')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card mb-2">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-4">
                                    ...
                                    <select name="multidevice" id="multidevice" class="form-control @error('multidevice') is-invalid @enderror ">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="Edit" href="{{route('user.whatsapp.editapi',$item->id)}}" class="badge bg-primary p-2"><i class="fas fa-pen"></i></a>
...
<div class="modal fade" id="whatsappDelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
        	<form action="{{route('user.whatsapp.delete')}}" method="POST">
        		@csrf
...
<script>
    ...
    function deviceStatusUpdate(id,status,className='',beforeSend='',afterSend='') {
        ...
        $('#qrQuoteModal').modal('hide');
           $.ajax({
            headers: {'X-CSRF-TOKEN': "{{csrf_token()}}"},
            url:"{{route('user.whatsapp.statusupdate')}}",
