...
<section class="mt-3 rounded_box">
	<div class="container-fluid p-0 mb-3 pb-2">
            ...
            <div class="col-md-12">
                <div class="table_heading d-flex align--center justify--between">
                    <nav aria-label="breadcrumb">
					  	<ol class="breadcrumb">
					    	<li class="breadcrumb-item"><a href="{{route('user.whatsapp.api')}}">{{ translate('Whatsapp Device')}}</a></li>
		...
		<div class="row justify-content-center">
			<div class="col-xl-4">
                <form action="{{route('user.whatsapp.update')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card mb-2">
