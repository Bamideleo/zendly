	                ...
	                <div class="row align--center px-2">
	                	...
	                	<div class="col-12 col-md-8 col-lg-8 col-xl-7">
	                		<div class="row justify-content-end">
								...
								<div class="col-12 col-md-4 col-lg-4 col-xl-3 py-1">
			                    	<a href="{{route('user.email.lead')}}" class="w-100 d-block btn--success text--light border-0 px-1 py-2 rounded ms-2"><i class="las la-plus"></i>  {{ translate('Get Lead')}}</a>
			                    </div>
